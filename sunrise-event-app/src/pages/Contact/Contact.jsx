...
const Contact = () => {
  ...
  return (
    <div className="!bg-[#fcc774] !min-h-screen !flex !flex-col !pt-10 fade-in">
      <Navbar />

      {/* Centered Logo & Title */}
      <div className="!flex !flex-col !items-center !justify-center !text-center !mt-8 !px-6 md:!px-10 slide-in-right">
        <img src={logo} alt="Logo" className="!h-24 !w-24 !mb-3 !mx-auto scale-up" />
      ...
      {/* Contact Section */}
      <div className="!max-w-6xl !mx-auto !flex !flex-wrap !bg-white !shadow-lg !rounded-lg !p-6 md:!p-10 !mt-10 fade-in">
        
        {/* Left Column (Contact Details) */}
        <div className="!w-full md:!w-1/2 !p-5 !text-gray-700 slide-in-left">
        ...
        <div className="!w-full md:!w-1/2 !p-5 slide-in-right">
          <form onSubmit={onSubmit} className="!bg-white !p-6 md:!p-8 !shadow-md !rounded-lg">
            ...
            <span className={`!block !mt-3 !font-bold ${result ? "scale-up" : ""} !text-green-600`}>
              {result}
            </span>
          </form>
        </div>
